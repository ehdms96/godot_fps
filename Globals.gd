...
var audio_clips = {
	"pistol_shot" : load("res://audio/gun_revolver_pistol_shot_04.wav"),
	"rifle_shot" : load("res://audio/gun_submachine_auto_shot_00_automatic_preview_01.wav"),
	"gun_cock" : load("res://audio/gun_semi_auto_rifle_cock_02.wav")
}
...
func play_sound(sound_name, loop_sound=false, sound_position=null):
	...
	# If we do not have an audio clip with the name sound_name, print a error message
		...
		print ("ERROR: " + sound_name + "cannot play sound that does not exist in audio_clips!")
